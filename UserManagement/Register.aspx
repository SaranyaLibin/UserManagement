    ...
    <table>
        ...
        <tr>
            ...
            <td class="auto-style8">
                ...
                <asp:Calendar ID="register_calendar" runat="server" SelectionMode="DayWeekMonth" OnSelectionChanged="CalendarSelectionChanged" style="margin-left: 227px" CssClass="auto-style5"></asp:Calendar>
            </td>
        </tr>
        <tr>
            <td>
        ...
        <asp:Button ID="btn_register" runat="server" OnClick="btn_register_Click" Text="Sign Up" CssClass="uibutton" Width="217px"/>
